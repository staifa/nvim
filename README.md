...
[Mason](https://github.com/williamboman/mason.nvim) is used as a tool of choice. To bring up the ui, execute `:Mason`. Clojure, Lua and Fennel LSs should be installed automatically.
