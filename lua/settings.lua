...
local options = {autowriteall = true, expandtab = true, tabstop = 2, shiftwidth = 2, softtabstop = 2, mouse = "", diffopt = "vertical", lazyredraw = true, synmaxcol = 128, undodir = (vim.fn.stdpath("config") .. "/.undo"), undofile = true, cmdheight = 0, scrolloff = 15, sidescrolloff = 35, ignorecase = true, hidden = true, smartcase = true, clipboard = "unnamedplus", number = true, ruler = true, signcolumn = "number", swapfile = false, backup = false}
