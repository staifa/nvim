...
local cmp_srcs = {{name = "nvim_lsp", group_index = 1}, {name = "conjure", group_index = 2}, {name = "buffer", group_index = 1}, {name = "luasnip", group_index = 2}}
...
local function mappings(cmp0)
  ...
  return {["<C-p>"] = cmp0.mapping.select_prev_item(), ["<C-n>"] = cmp0.mapping.select_next_item(), ["<C-u>"] = cmp0.mapping.scroll_docs(( - 4)), ["<C-d>"] = cmp0.mapping.scroll_docs(4), ["<C-Space>"] = cmp0.mapping.complete(), ["<C-x>"] = cmp0.mapping.close(), ["<CR>"] = cmp0.mapping.confirm({behavior = cmp0.ConfirmBehavior.Replace, select = true}), ["<Esc>"] = cmp0.mapping(_2_), ["<Tab>"] = cmp0.mapping(_4_, {"i", "s"}), ["<S-Tab>"] = cmp0.mapping(_6_, {"i", "s"})}
end
